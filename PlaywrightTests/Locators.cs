...
public static class Locators{
    public static string Username = "[data-test=\"username\"]";
    public static string Password = "[data-test=\"password\"]";
    public static string LoginButton = "[data-test=\"login-button\"]";
    ...
    public static string GoToCartButton = "[data-test=\"shopping-cart-link\"]";
    public static string GoToCheckout = "[data-test=\"checkout\"]";
